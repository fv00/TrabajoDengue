...
En todos los gráficos anteriores podemos ver como, a pesar de que hay varias variables para temperatura, humedad, etc. Estas explican básicamente lo mismo sobre la cantidad de casos de dengue en cada momento; por lo que porbablemente sólo se utilice una de cada una de este tipo.